...
class ViewController: UIViewController, AVAudioRecorderDelegate, AVAudioPlayerDelegate {
    ...
    //function to find a local directory path to save sound file
    ...
    //function to find a local directory path to save video file
    func videUrl() -> NSURL? {
    ...
    //manage data flow asyncronessly
    ...
    //finish recording function and settings
    ...
    //returns a new, temporary url to save data locally
    func tempURL() -> URL? {
    ...
    @IBAction func recordAction(_ sender: Any) {
        if audioRecorder == nil {
            ...
            //save file remotely and play locally
   ...
   //make the camera view dragable
    ...
    //merge audio and video to one file
...
//data output for live smile tracking and writing the video and audio file
